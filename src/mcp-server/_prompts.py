...
def _get_parser_based_prompt() -> str:
    """System prompt for the parsing-based approach - SIMPLIFIED with separate ID parameters."""
    return """Use goat_query to answer genomic data questions about GoaT.
...
5️⃣ **taxon_filter_type**: Type of taxon filter to apply if taxa provided
   Options:
   - "children" (default): e.g. "families in Felis"
   - "matching": e.g. "matching Canis*", "for Nymphalidae"
   - "lineage": e.g. "lineage of Mammalia", "parent taxa of Felis"

6️⃣ **user_query**: Copy the original question
...
Step 5: taxon_filter_type → "children"
Step 6: user_query → Copy exactly
Step 7: Check modifiers → ✓ Combined in ONE dict
...
DO NOT CALL unless you've completed all 7 steps above!
"""
